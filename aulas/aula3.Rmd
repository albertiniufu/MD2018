...
Um exempo é a coluna `cessoes$Data.da.Cessao` cujo tipo de dado pode ser transformado em `Date` da seguinte forma:

```{r}
cessoes$Data.da.Cessao = format.Date(as.character(cessoes$Data.da.Cessao),"%D/%m/%Y")
```
